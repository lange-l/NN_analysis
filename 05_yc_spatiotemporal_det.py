...
cond_names = ['det/anat', 'undet/anat', 'det/loc/anat', 'undet/loc/anat', 'undet/noloc/anat',
              'det/cross', 'undet/cross', 'det/loc/cross', 'undet/loc/cross', 'undet/noloc/cross',
              'det/overall', 'undet/overall', 'det/loc/overall', 'undet/loc/overall', 'undet/noloc/overall']

# enter indices of conditions to be compared:
cond1, cond2, cond3, cond4 = 0, 1, 5, 6
...
conds_to_plot = [cond_names[cond1], cond_names[cond2], cond_names[cond3], cond_names[cond4]]
...
for subj in subj_names:
    ...
    epo_undet_loc_anat = epochs[((epochs.metadata.det == 'missF1') | (epochs.metadata.det == 'missF2')) &
                                ((epochs.metadata.loca == 'hit') | (epochs.metadata.loca == 'CR')) &
                                (epochs.metadata.block_type == 1)]
    epo_undet_noloc_anat = epochs[((epochs.metadata.det == 'missF1') | (epochs.metadata.det == 'missF2')) &
                                  ((epochs.metadata.loca == 'miss') | (epochs.metadata.loca == 'FA')) &
                                  (epochs.metadata.block_type == 1)]
    ...
    epo_undet_loc_cross = epochs[((epochs.metadata.det == 'missF1') | (epochs.metadata.det == 'missF2')) &
                                 ((epochs.metadata.loca == 'hit') | (epochs.metadata.loca == 'CR')) &
                                 (epochs.metadata.block_type == 2)]
    epo_undet_noloc_cross = epochs[((epochs.metadata.det == 'missF1') | (epochs.metadata.det == 'missF2')) &
                                   ((epochs.metadata.loca == 'miss') | (epochs.metadata.loca == 'FA')) &
                                   (epochs.metadata.block_type == 2)]
    # overall
    epo_det_overall = epochs[((epochs.metadata.det == 'hitF1') | (epochs.metadata.det == 'hitF2'))]
    epo_undet_overall = epochs[((epochs.metadata.det == 'missF1') | (epochs.metadata.det == 'missF2'))]
    epo_det_loc_overall = epochs[((epochs.metadata.det == 'hitF1') | (epochs.metadata.det == 'hitF2')) &
                                 ((epochs.metadata.loca == 'hit') | (epochs.metadata.loca == 'CR'))]
    epo_undet_loc_overall = epochs[((epochs.metadata.det == 'missF1') | (epochs.metadata.det == 'missF2')) &
                                   ((epochs.metadata.loca == 'hit') | (epochs.metadata.loca == 'CR'))]
    epo_undet_noloc_overall = epochs[((epochs.metadata.det == 'missF1') | (epochs.metadata.det == 'missF2')) &
                                     ((epochs.metadata.loca == 'miss') | (epochs.metadata.loca == 'FA'))]

    conditions = [epo_det_anat, epo_undet_anat, epo_det_loc_anat, epo_undet_loc_anat, epo_undet_noloc_anat,
                  epo_det_cross, epo_undet_cross, epo_det_loc_cross, epo_undet_loc_cross, epo_undet_noloc_cross,
                  epo_det_overall, epo_undet_overall, epo_det_loc_overall, epo_undet_loc_overall,
                  epo_undet_noloc_overall, ]
    ...
    mne.epochs.equalize_epoch_counts([conditions[cond3], conditions[cond4]])
...
del epo_det_anat, epo_undet_anat, epo_det_cross, epo_undet_cross, epo_det_loc_anat, epo_undet_loc_anat, \
    epo_undet_noloc_anat, epo_det_loc_cross, epo_undet_loc_cross, epo_undet_noloc_cross, av_epochs, conditions, cond, \
    average, subj_matrix, i, m, subj
